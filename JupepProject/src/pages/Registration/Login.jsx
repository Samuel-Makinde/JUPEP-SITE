  ...
  return (
    <main className="-full h-full  font-body  text-secH ">
      ...
      <div className=" w-full min-h-screen md:grid md:grid-cols-2">
        ...
        <p className="text-pS text-primary1 mt-[20px] font-medium">We&apos;re thrilled to have you return to our learning community. Get ready for another exciting chapter of exploration and knowledge. From engaging reading sessions to interactive practice, we&apos;re here to make your learning journey exceptional. Let&apos;s dive back in together and make every moment count!</p>
        <div className="mt-[120px] ">
          ...
          <p className="text-pS text-primary1 mt-[20px] font-medium">This site has truly transformed my study experience! The seamless online reading platform, extensive bank of practice exam questions, and the interactive EaseReads A.I for answering questions make learning incredibly engaging. The ability to schedule reading tasks keeps me organized, and the informative videos for each topic provide valuable insights. A must-visit for students looking for a comprehensive and user-friendly educational resource!</p>
          <div className="mt-[20px] w-[239px] h-[70px] flex justify-between items-center">
            <img src={samuel} alt="user" className="w-[70px] h-full rounded-xl " />
          ...
          <FaArrowLeftLong size={27} className="text-primary1" />
            ...
            <div className="w-full  mt-[20px]">
              ...
              <p className="text-secH mt-[25px]">
                Log in to continue your learning journey and explore a world of endless possibilities with EaseReads.
              </p>
            </div>
          <form
      ...
      <div className=" flex flex-col justify-center items-center md:flex-none ">
            ...
            :
            <div className="w-full h-[60px] mt-[40px] flex justify-center bg-primary0Blue hover:bg-opacity-80  text-[16px] md:text-[20px] rounded-[12px] text-primary1 cursor-pointer" disabled>
              <button className="w-full h-full" type="submit">
                Login
              </button>
            </div>
            ...
            <p className="text-[#2F3035] text-[16px] leading-[20.22px] font-normal mt-[30px] text-center">
              ...
              <Link to="/sign-up" smooth="true" duration={500}>
                <button className="text-primary0Blue font-medium">Sign Up.</button>
              </Link>
            </p>
      </div>
