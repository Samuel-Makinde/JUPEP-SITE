        ...
        <div className="w-full h-full md:w-8/12 lg:w-7/12 xl:w-6/12 pb-[20px] md:bg-white md:shadow-lg md:rounded-[8px] flex flex-col justify-center items-center">
          ...
          >
            ...
            <div className="w-full flex justify-between text-[16px] mt-[25px]">
              ...
              <p className="text-blue-900 text-[16px] leading-[15.22px]  cursor-pointer font-semibold">
                Forgot Password?
              </p>
              </Link>
            </div>
            <div className="w-full h-[60px] mt-[40px] flex justify-center bg-blue-900 opacity-80 hover:opacity-100 text-[16px] md:text-[20px] rounded-[12px] text-white cursor-pointer">
