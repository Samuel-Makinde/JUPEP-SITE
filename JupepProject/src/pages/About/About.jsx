...
const About = () => {
  return (
    <Layout>
      <div className="">
        {/* 1ST PART */}
        <div className="w-full lg:flex md:flex-col-2 md:flex-row pt-[6rem] lg:space-b md:px-[5rem] ">
          <div className="sm:w-[35rem] pt-[3rem] md:h-auto md:mx-auto md:h-[23rem]  lg:pt-[3rem]">
            <img className=" lg:w-[100rem] " src={learning} alt="service" />
          </div>
          <div className="sm:w-full lg:pl-[5rem] lg:w-3/5 lg:pt-[6rem]">
            <h2 className="sm:text-xl sm:pt-[3rem] md:text-2xl pb-[1rem]">
              About Us
            </h2>
            ...
            <p className="pt-[10px]">
              ...
              deleniti dolor doloremque, adipisci itaque quibusdam ipsum cum ut
        ...
        {/* 2nd Part */}
        <div className="bg-primary4 lg:flex md:flex-col-2 md:flex-row mt-[5rem] lg:py-[7rem] md:px-[5rem]">
          ...
          <div className="md:pt-[3rem] lg:pt-[3rem] lg:pr-[2rem] lg:pl-[10rem]">
            <img
        ...
        {/* 3rd Part */}
        <div className="w-full lg:flex md:flex-col-2 md:flex-row pt-[4rem] lg:space-b md:px-[5rem]">
          <div className="sm:w-[35rem] pt-[3rem] md:h-auto md:mx-auto md:h-[23rem]  lg:pt-[3rem]">
            <img className=" lg:w-[100rem] " src={group} alt="service" />
          </div>
          <div className="sm:w-full lg:pl-[5rem] lg:w-3/5 lg:pt-[7rem]">
            <h2 className="sm:text-xl md:text-3xl font-bold pb-[1rem] text-sec2">
              Our Vision
            </h2>
        ...
        {/* 4th Part */}
        <div className="bg-primary4 lg:flex md:flex-col-2 md:flex-row mt-[5rem] lg:py-[7rem] md:px-[5rem]">
          <div className="lg:pr-[4rem] pt-[12rem] lg:w-3/5">
            <h2 className="sm:text-xl md:text-3xl  font-bold pb-[1rem] text-sec2">
              Our Commitment
            </h2>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam
          ...
          <div className="md:pt-[3rem] lg:pt-[3rem] lg:pr-[2rem] lg:pl-[3rem]">
            <img
              className="sm:w-[35rem] md:h-auto md:mx-auto md:h-[23rem] lg:w-[50rem] lg:pl-[1rem]"
              src={reading}
              alt="service"
