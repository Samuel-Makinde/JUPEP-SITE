          ...
          <div className="w-full px-4 md:px-6 lg:px-8 xl:px-20 flex flex-col-reverse md:flex-row md:justify-between mt-[70px]">
            ...
            <div className="w-full h-full    flex flex-col items-center ">
              ...
              <p className="w-full md:w-8/12 text-center  text-[16px] text-primary3 ">
                We&apos;ve tackled the Jupeb reading problem by offering
                students a flexible solution. With our program, you can study
                anytime, anywhere using your device. We provide weekly video
                calls where experienced instructors explain specific topics in
                detail, ensuring you understand them thoroughly. Our active
                WhatsApp community is there to support you, allowing you to ask
                questions and find help on challenging subjects. We also offer a
                wealth of Jupeb past questions and answers for practice, and our
                textbooks contain detailed explanations for all topics in
                subjects 001/002/003/004. This comprehensive approach empowers
                students to excel in their Jupeb exams.
              </p>
            </div>
          </div>
          <div className="w-full h-full ">
              ...
              <div className="w-full h-full py-4 md:py-12 bg-primary4  md:px-6 lg:px-8 xl:px-20 flex flex-col-reverse md:flex-row-reverse md:justify-between mt-[30px]">
                <div className="w-full flex mt-8 md:mt-0  justify-center md:flex-none md:w-5/12">
                  <img
                    src={reading}
                    alt="about"
                    className="h-[350px] md:h-[400px] w-[400px] "
                  />
                </div>
                <div className=" px-4 md:px-0  md:w-5/12 md:text-left flex flex-col  ">
                  ...
                  <p className=" text-left   text-[16px] text-primary3">
                    We&apos;ve tackled the Jupeb reading problem by offering
                    students a flexible solution. With our program, you can
                    study anytime, anywhere using your device. We provide weekly
                    video calls where experienced instructors explain specific
                    topics in detail, ensuring you understand them thoroughly.
                    Our active WhatsApp community is there to support you,
                    allowing you to ask questions and find help on challenging
                    subjects. We also offer a wealth of Jupeb past questions and
                    answers for practice, and our textbooks contain detailed
                    explanations for all topics in subjects 001/002/003/004.
                    This comprehensive approach empowers students to excel in
                    their Jupeb exams.
                  </p>
            ...
            <div className="w-full px-4 md:px-6 lg:px-8 xl:px-20 mt-[130px] ">
              ...
              <p className="md:w-6/12 text-primary5 font-normal text-base ">
                Lorem ipsum dolor sit amet consectetur. Morbi tempus
                pellentesque sit a. Ut mattis vivamus hac est maecenas mi
                lobortis. Urna vulputate dignissim netus.
              </p>
            </div>
            <div
            ...
            <div className="w-full h-full py-4 md:py-12 bg-primary4   md:px-6 lg:px-8 xl:px-20 flex flex-col-reverse md:flex-row md:justify-between mt-[130px]">
              ...
              <div className=" px-4 md:px-0 md:w-6/12 flex flex-col  ">
                ...
                <p className="  text-[16px] text-primary3">
                  ...
                  calls where experienced instructors explain specific topics in
                  detail, ensuring you understand them thoroughly. Our active
                  WhatsApp community is there to support you, allowing you to
                  ask questions and find help on challenging subjects. We also
                  offer a wealth of Jupeb past questions and answers for
                  practice, and our textbooks contain detailed explanations for
                  all topics in subjects 001/002/003/004. This comprehensive
                  approach empowers students to excel in their Jupeb exams.
                </p>
                <button className="w-full md:w-[220px] mt-[20px] h-[59px] bg-primary0Blue hover:bg-sec3 flex justify-center items-center text-primary1 font-body text-xl rounded-[45px]">
                  Take Exams
                </button>
            ...
            <div className="w-full  mt-[60px] ">
              <div className="w-full md:flex md:justify-between">
                <div className="md:w-[45%] h-full">
                  ...
                  <p className="text-pS text-secH mt-[20px] font-medium font-roboto">
                    This site is a game-changer! From the moment I signed up,
                    the experience has been nothing short of exceptional. The
                    diverse range of resources, interactive learning features,
                    and the ability to connect with ChatGPT for questions have
                    made studying a joy. The user-friendly interface and
                    well-structured content make it easy to navigate. <br />
                    Five stars without a doubt — this platform has enriched my
                    learning journey in ways I couldn&apos;t have imagined!
                  </p>
              ...
              <div className="w-full md:flex md:justify-between mt-16">
                <div className="md:w-[45%] h-full">
                  ...
                  <p className="text-pS text-secH mt-[20px] font-medium font-roboto">
                    ...
                    and the ability to connect with ChatGPT for questions have
                    made studying a joy. The user-friendly interface and
                    well-structured content make it easy to navigate.
                    <br />
                    Five stars without a doubt — this platform has enriched my
                    learning journey in ways I couldn&apos;t have imagined!
                  </p>
