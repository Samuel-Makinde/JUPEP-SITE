      ...
      <main className="w-full h-full px-4 md:px-6 xl:px-10 pb-[120px] dark:text-lightGray dark:bg-darkBlue">
        <div className="w-full h-full pt-[120px]">
          <div className="w-full h-full  text-center">
            ...
            <p className="mt-[40px] dark:text-lightGray">
              Welcome to easereads.com. We respect your privacy and are
          ...
          <div className="w-full h-full mt-[70px]">
            <div className="w-full h-full">
              <h2 className="font-semibold text-[20px] mt-[5px]">
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                <li className="font-bold mt-[5px]">
                  Usage Information:{" "}
                  <span className="font-normal">
                    We may collect information about your usage of our website,
                    including the pages you visit, the content you view, and
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                <li>
                  To provide access to educational content and resources on our
                  website.
                </li>
                <li className="mt-[5px]">
                ...
                <li className="mt-[5px]">
                  To improve our website&apos;s functionality, content, and user
                  experience.
                </li>
              </ul>
            </div>
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                <li className="font-bold mt-[5px]">
                  ...
                  <span className="font-normal">
                    ...
                    obligations, such as responding to subpoenas or court
                    orders.
                  </span>
                </li>
                <li className="font-bold mt-[5px]">
                  ...
                  <span className="font-normal">
                    ...
                    part of our assets, your personal information may be
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p>
                You can make certain choices regarding your personal
                information:
              </p>
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                <li className="font-bold">
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                destruction. However, please be aware that no security measures
                are perfect.
              </p>
            </div>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                from unauthorized access, disclosure, alteration, and
                destruction. However, please be aware that no security measures
                are perfectWe may update this privacy policy from time to time.
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                09064766113 or easereads@gmail.com.
              </p>
            </div>
          </div>
        </div>
