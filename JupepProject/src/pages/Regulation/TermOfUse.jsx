...
const TermOfUse = () => {
  return (
    <Layout>
      <main className="w-full h-full px-4 md:px-6 xl:px-10 pb-[120px] dark:text-lightGray dark:bg-darkBlue">
        <div className="w-full h-full pt-[120px]">
          <div className="w-full h-full  text-center">
            <h1 className="w-full h-full  text-[25px] font-semibold">
          ...
          <div className="w-full h-full mt-[70px]">
            <div className="w-full h-full">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                By using www.easereads.com , you agree to comply with and be
                bound by these Terms of Use (&quot;Agreement&quot;) If you do
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                Use at any time without notice. Your continued use of the
                Website after any changes shall constitute your consent to such
                changes.
              </p>
            </div>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                <li>
                  You may use the Website for educational and informational
                  purposes only.
                </li>
                <li className="mt-[5px]">
                  You must not use the Website in any way that violates any
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] dark:text-lightGray text-gray-700 mt-[15px] text-[16px]  md:text-[18px]">
                <li>
                  All content on the Website, including but not limited to text,
                  graphics, images, and software, is owned by or licensed to us
                  and is protected by copyright and other intellectual property
                  rights.
                </li>
                <li className="mt-[5px]">
                  You may access, download, and print content for personal,
                  non-commercial use only. Any other use requires our prior
                  written consent.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] dark:text-lightGray text-gray-700 mt-[15px] text-[16px]  md:text-[18px]">
                <li>
                  ...
                  worldwide right to use, reproduce, modify, distribute, and
                  display the content.
                </li>
                <li className="mt-[5px]">
                  You must not submit content that violates any third-party
                  rights or contains harmful, illegal, or offensive materials.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                to the Website without notice for any reason, including a breach
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                <Link
                  ...
                  smooth="true"
                  duration={500}
                  className="font-bold text-gray-900 dark:text-sec2 ml-[4px] "
                >
                  Privacy Policy.
                </Link>
              </p>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                <li className="mt-[5px]">
                  We are not responsible for any errors or omissions on the
                  Website.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <ul className="list-disc ml-[50px] text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                <li className="mt-[5px]">
                  Our total liability for any claims arising under this
            ...
            <div className="w-full h-full mt-[50px]">
              ...
              <p className="text-gray-700 dark:text-lightGray mt-[15px] text-[16px]  md:text-[18px]">
                ...
                please contact us at 09064766113 or easereads@gmail.com.
              </p>
            </div>
          </div>
        </div>
