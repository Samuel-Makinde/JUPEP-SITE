...
import { SmallBox } from "../../../components/Cards/Box";
  ...
  return (
    <main className="lg:pl-[26%] 2xl:pl-[33%] w-full min-h-screen bg-primary1 dark:bg-navyBlue dark:text-primary1  h-full pt-14 px-6 2xl:px-12 pb-8 font-sans">
      ...
      <div className="lg:flex justify-between mt-5">
        ...
        />
        <SmallBox
          title="Purchase TextBooks"
          totalAmount={`4`}
          monthAmount="0"
        />
        <SmallBox title="Purchase Videos" totalAmount={`7`} monthAmount="2" />
        <SmallBox title="Exam Practices" totalAmount={`6`} monthAmount="2" />
      </div>
      ...
      <div className="w-full h-full dark:bg-primary3 shadow-2xl rounded-[10px] mt-16  ">
        ...
        <div className="w-full h-16 text-primary1 2xl:h-24 bg-primary2 mb-5 px-4 2xl:px-8 font-semibold  flex justify-center items-center">
          ...
          <p className="w-[22%]">Method</p>
          <p className="w-[23%]">Status</p>
          {/* <p className="w-[10%] ">Action</p> */}
        </div>

        <div className="w-full  h-full pt-2 dark:text-primary7">
          {currentTransactions.map((transaction, index) => {
            const { id, amount, date_time, type, status, Subjects } =
              transaction;
            return (
              <div
                key={id}
              ...
              >
                ...
                <p className="w-[30%]">
                  ...
                  {amount ? amount : "Not available"} <br />
                </p>
                <p className="w-[22%]">
                  {type ? type : "Not available"}
                  {/* {type} */}
                </p>
                <div className="w-[23%]  text-primary3">
                  <p
