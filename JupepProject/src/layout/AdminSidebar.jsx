...
const AdminSidebar = () => {
  ...
  return (
    <main className="fixed w-[23%] 2xl:w-[25%] top-0 h-screen flex flex-col items-center bg-white shadow-2xl pt-[120px] 2xl:pt-[165px] ">
            ...
            <NavLink to="/admin/" 
            className={`w-[80%] 2xl:h-[86px] h-[50px] text-[#625E5E] ${isActive === "/admin/home" ? "rounded-[10px] bg-black text-white" : ""} hover:bg-black  hover:text-white hover:rounded-[10px]`}
            onClick={() => handleOptionClick("/admin")}
            >
            <button className="w-full h-full flex justify-center items-center font-semibold">
                {isActive === "/admin/home" ? <img src={dashboard} alt="dashborad" className="mr-[20px] " />
