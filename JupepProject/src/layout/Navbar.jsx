...
const Navbar = () => {
  ...
  return (
    <main className="fixed w-full h-[60px] md:h-[90px] flex items-center md:grid md:grid-cols-3 md:gap-4 px-4 bg-white shadow-sm z-20 font-euclid">
      ...
      <div className="hidden md:flex lg:w-[400px] md:w-[250px] h-full items-center justify-center ">
        ...
        <div className="bg-blue-700 w-[36px] h-[30px] absolute ml-[200px] lg:ml-[350px] rounded-[40px] cursor-pointer">
          ...
          <BsSearch size={26} className="text-white pt-[5px] pl-[6px]" />
        </div>
      </div>
