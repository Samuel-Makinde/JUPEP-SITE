...
const Courses = () => {
    ...
    const coursecards = [
       
        {
            ...
            page: "200",
            rating: "4.5",
            description:'Yes, our Jupeb textbooks cover all topics in subjects 001, 002, 003, and 004, providing detailed explanations to support your learning',
            topics: [
    ...
    const handleClick = (coursecard) => {
        navigate(`/book-details/${coursecard.course}`, { state: { courseDetails: coursecard } });
      };
